...
manejo de excepciones, formateo de numeros decimales y manipulacion de lista de datos.*/ 
...
//Clase encargada de gestionar la Interfaz de Transferencia de dinero.
public class TransferirDinero extends javax.swing.JFrame {
    ...
    para la operacion de transferecia.*/
    ...
    /*Metodo/Boton encargado de confirmar la transferencia de dinero, mandandonos un mesaje de transferencia exitosa en caso
    ...
    //Metodo encargado de registrar en un archivo las transferencias de dinero realizadas por el remitente al historial del destinatario.
    ...
    /*Metodo encargado de descontar el monto de dinero ingresado desde el saldo de la cuenta con la que se esta
    resalizando la transferencia de dinero*/ 
    ...
    //Metodo contenedor del campo Numero de cuenta a transferir donde se escribira, el numero de cuenta a enviar el dinero.
    ...
    //Metodo contenedor del campo cantidad de dinero a transferir donde se escribira, el monto de dinero que queramos transferir.
    ...
    /*Metodo encargado de calcular el cambio de dinero de una moneda a otra, para luego retornar la
    cantidad de dinero convertira del tipo de moneda que se requeria.*/
    ...
    //Metodo encargado de registrar en un archivo las transferencias de dinero realizadas por el cliente.
    ...
    //Metodo encargado de traducir todo el texto en espanol de la interfaz "TransferirDinero" al idioma Ingles.
    public void ingles(){
    ...
    //Metodo encargado de traducir todo el texto en espanol de la interfaz "TransferirDinero" al idioma Quechua.
    public void quechua(){
